...
class ContactsCtrl {
	...
	public function action_contacts() {
		$limit = 2;  
		$current_page = ParamUtils::getFromCleanURL(1);
		//$this->offset = $limit * ($current_page - 1); 
		...
		//limit i offset
		$where ["LIMIT"] = [$limit * ($current_page - 1), $limit];
		...
		$this->page = $current_page; // na potrzeby przekazania do widoku (przejścia lewo/prawo)


        // 4. wygeneruj widok
        App::getSmarty()->assign('searchForm', $this->form); // dane formularza (wyszukiwania w tym wypadku)
		App::getSmarty()->assign('page', $this->page);
        App::getSmarty()->assign('people2', $this->records);  // lista rekordów z bazy danych
        App::getSmarty()->display('contacts.tpl'); 
